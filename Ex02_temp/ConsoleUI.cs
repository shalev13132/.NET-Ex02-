...
namespace Ex02_01
{
    public static class ConsoleUI
    {
        ...
        public static void DisplayCaptureMessage(Players currentPlayer)
        {
            Console.WriteLine($"{currentPlayer.PlayerName} performed a capture!");
        }
        ...
        /*public static void DisplayCaptureMessage(Players currentPlayer)
        {
            Console.WriteLine("{0} performed a capture move!", currentPlayer.PlayerName);
        }
        */
    }
}